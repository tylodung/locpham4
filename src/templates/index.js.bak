...
const IndexPage = ({ data, pathContext }) => {
  ...
  return (
      ...
      <div className="home-template">
        ...
        <Header image='https://s3-ap-southeast-1.amazonaws.com/img.spiderum.com/sp-images/25dff180f88d11e78f673bd033826b1f.jpg' title="Thái Y" tagline="Hoàng Đế Nội Kinh.." />
